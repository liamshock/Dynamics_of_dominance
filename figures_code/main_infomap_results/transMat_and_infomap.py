...
parser.add_argument('dppMax', type=int,
                    help='the highest value of the dpp bins')
...
# ---------- dpp bins ----------#
dpp_bins = np.arange(0, dppMax+1, 1)
...
sorted_eig_vals, sorted_eig_vecs = compute_top_K_eigs_sorted_by_largest_mag(edited_tmat,
                                                                            k=k)
